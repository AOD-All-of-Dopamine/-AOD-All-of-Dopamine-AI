"""h55 검색 — 분업(max) vs 합성(min) 질의. 등록 md5 b93803c8fd1eb15b0e128bb86c16bfd5."""
...
LAM=0.35; DOMS=('wn','steam','tmdb'); SEEDS=list(range(10)); K=3; TOP20=20
...
json.dump(out, open(f"{SP}/h55_pools.json","w"), ensure_ascii=False, indent=1)
