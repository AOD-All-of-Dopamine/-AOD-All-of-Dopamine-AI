...
#: 인기도 백분위 버그 수정(미보고를 순위에서 제외) 설정의 k=50 신규 칸 69쌍.
#: 판정은 후보의 내재적 타당성만 보고 매겼다 — 어느 설정에서 왔는지는 점수에 쓰지 않는다.
BLIND_PCT15 = {
    ("coh_indie_platformer", 400): (1, "GENRE_ONLY"),

    ("coh_jrpg", 867210): (1, "GENRE_ONLY"),
    ("coh_jrpg", 973760): (2, ""),
    ("coh_jrpg", 1082710): (3, ""),
    ("coh_jrpg", 226840): (1, "GENRE_ONLY"),
    ("coh_jrpg", 790820): (3, ""),

    ("coh_mmo", 379430): (1, "GENRE_ONLY"),
    ("coh_mmo", 686810): (0, "IRRELEVANT"),
    ("coh_mmo", 223100): (0, "IRRELEVANT"),
    ("coh_mmo", 311310): (2, ""),
    ("coh_mmo", 1337520): (1, "GENRE_ONLY"),
    ("coh_mmo", 1888160): (0, "IRRELEVANT"),
    ("coh_mmo", 1218210): (0, "IRRELEVANT"),
    ("coh_mmo", 4570720): (1, "GENRE_ONLY"),
    ("coh_mmo", 2933130): (1, "GENRE_ONLY"),

    ("coh_sports", 3551340): (2, ""),
    ("coh_sports", 1583320): (2, ""),

    ("longtail_deckbuilder", 2693930): (3, ""),
    ("longtail_deckbuilder", 698640): (3, ""),

    ("longtail_detective", 1341290): (2, ""),
    ("longtail_detective", 1156990): (2, ""),

    ("longtail_puzzle_platformer", 1201270): (2, ""),

    ("lowrev_cozy_narrative", 1574580): (2, ""),
    ...
    ("lowrev_towerdefense", 1367550): (3, ""),
    ("lowrev_towerdefense", 410320): (1, "GENRE_ONLY"),

    ("mix2_arcade_action", 389730): (3, ""),
    ("mix2_builder_sim", 979120): (3, ""),
    ("mix2_coop_horror", 1063420): (2, ""),
    ("mix2_party_narrative", 729040): (1, "GENRE_ONLY"),
    ...
    ("niche_cozy_casual", 508900): (1, "LOW_QUALITY"),
    ("niche_cozy_casual", 1260520): (3, ""),

    ("niche_roguelite", 651670): (3, ""),
    ("niche_roguelite", 269210): (2, ""),

    ("niche_soulslike_solo", 435150): (1, "GENRE_ONLY"),
    ("niche_soulslike_solo", 617290): (3, ""),
    ("niche_soulslike_solo", 1337520): (1, "GENRE_ONLY"),
    ("niche_soulslike_solo", 250400): (0, "IRRELEVANT"),

    ("niche_tactics", 686060): (3, ""),
    ("niche_tactics", 2784470): (3, ""),

    ("six_action_adv", 2417610): (3, ""),
    ("six_action_adv", 1496790): (3, ""),
    ("six_action_adv", 425580): (0, "IRRELEVANT"),
    ("six_action_adv", 647830): (1, "GENRE_ONLY"),
    ("six_action_adv", 405310): (1, "GENRE_ONLY"),

    ("twenty_broad", 1167630): (2, ""),
    ("twenty_broad", 1151340): (2, ""),
    ("twenty_broad", 65300): (2, ""),
    ("twenty_broad", 617290): (2, ""),

    ("two_cozy_puzzle", 461840): (2, ""),
    ("two_cozy_puzzle", 1679320): (1, "LOW_QUALITY"),
    ("two_cozy_puzzle", 837470): (3, ""),
    ("two_cozy_puzzle", 674140): (2, ""),
    ("two_cozy_puzzle", 1622770): (2, ""),
    ("two_cozy_puzzle", 4160210): (3, ""),
    ("two_cozy_puzzle", 2303350): (2, ""),

    ("two_rhythm_arcade", 1274570): (0, "IRRELEVANT"),
    ("two_rhythm_arcade", 552500): (0, "IRRELEVANT"),
    ("two_rhythm_arcade", 1929610): (0, "IRRELEVANT"),
}


#: 시드 개수 축 9개 프로필(5·7·10시드) k=50 전수 판정 450쌍. 단일 설정이라
#: 블라인딩 대상이 아니다 — 이 축의 기준선을 세우는 최초 측정이다.
BLIND_SEEDCOUNT = {
    # five_coop_shooter  P@50 0.80
    ("five_coop_shooter", 235540): (3, ""),
    ("five_coop_shooter", 1272080): (3, ""),
    ("five_coop_shooter", 1250): (3, ""),
    ("five_coop_shooter", 1492070): (3, ""),
    ("five_coop_shooter", 15620): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 258970): (2, ""),
    ("five_coop_shooter", 3595270): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 699130): (3, ""),
    ("five_coop_shooter", 394510): (3, ""),
    ("five_coop_shooter", 1142710): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 550): (3, ""),
    ("five_coop_shooter", 24240): (3, ""),
    ("five_coop_shooter", 774241): (2, ""),
    ("five_coop_shooter", 843200): (2, ""),
    ("five_coop_shooter", 1065310): (2, ""),
    ("five_coop_shooter", 694280): (3, ""),
    ("five_coop_shooter", 3595230): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 2344520): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 230410): (3, ""),
    ("five_coop_shooter", 924970): (3, ""),
    ("five_coop_shooter", 1037080): (2, ""),
    ("five_coop_shooter", 1245620): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 415590): (3, ""),
    ("five_coop_shooter", 3556750): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 2928280): (2, ""),
    ("five_coop_shooter", 1430190): (3, ""),
    ("five_coop_shooter", 2904000): (2, ""),
    ("five_coop_shooter", 910490): (2, ""),
    ("five_coop_shooter", 414740): (3, ""),
    ("five_coop_shooter", 1962663): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 224260): (3, ""),
    ("five_coop_shooter", 104900): (2, ""),
    ("five_coop_shooter", 816090): (3, ""),
    ("five_coop_shooter", 493520): (3, ""),
    ("five_coop_shooter", 1548850): (2, ""),
    ("five_coop_shooter", 3552820): (2, ""),
    ("five_coop_shooter", 939100): (2, ""),
    ("five_coop_shooter", 2379390): (3, ""),
    ("five_coop_shooter", 2841770): (2, ""),
    ("five_coop_shooter", 656700): (2, ""),
    ("five_coop_shooter", 247910): (3, ""),
    ("five_coop_shooter", 780290): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 729040): (3, ""),
    ("five_coop_shooter", 2208570): (2, ""),
    ("five_coop_shooter", 34870): (1, "GENRE_ONLY"),
    ("five_coop_shooter", 292000): (3, ""),
    ("five_coop_shooter", 1351000): (2, ""),
    ("five_coop_shooter", 1268750): (3, ""),
    ("five_coop_shooter", 55150): (2, ""),
    ("five_coop_shooter", 866570): (2, ""),



    # seven_automation  P@50 0.72
    ("seven_automation", 1383150): (3, ""),
    ("seven_automation", 1112790): (3, ""),
    ("seven_automation", 2570210): (3, ""),
    ("seven_automation", 803050): (2, ""),
    ("seven_automation", 1509510): (2, ""),
    ("seven_automation", 2827680): (2, ""),
    ("seven_automation", 2354330): (2, ""),
    ("seven_automation", 919260): (3, ""),
    ("seven_automation", 1803550): (2, ""),
    ("seven_automation", 3427850): (2, ""),
    ("seven_automation", 1411740): (1, "GENRE_ONLY"),
    ("seven_automation", 3818850): (2, ""),
    ("seven_automation", 4667250): (2, ""),
    ("seven_automation", 1198740): (1, "GENRE_ONLY"),
    ("seven_automation", 3242950): (3, ""),
    ("seven_automation", 860890): (3, ""),
    ("seven_automation", 361420): (2, ""),
    ("seven_automation", 3602030): (1, "GENRE_ONLY"),
    ("seven_automation", 4834620): (2, ""),
    ("seven_automation", 3846120): (2, ""),
    ("seven_automation", 3780950): (2, ""),
    ("seven_automation", 1638300): (2, ""),
    ("seven_automation", 1129570): (1, "GENRE_ONLY"),
    ("seven_automation", 983870): (3, ""),
    ("seven_automation", 1878580): (1, "GENRE_ONLY"),
    ("seven_automation", 2389040): (3, ""),
    ("seven_automation", 647960): (0, "IRRELEVANT"),
    ("seven_automation", 1511460): (3, ""),
    ("seven_automation", 1013540): (2, ""),
    ("seven_automation", 4210580): (2, ""),
    ("seven_automation", 1403740): (2, ""),
    ("seven_automation", 979120): (3, ""),
    ("seven_automation", 383120): (1, "GENRE_ONLY"),
    ("seven_automation", 1733110): (1, "GENRE_ONLY"),
    ("seven_automation", 2779120): (3, ""),
    ("seven_automation", 2345020): (1, "GENRE_ONLY"),
    ("seven_automation", 1614550): (3, ""),
    ("seven_automation", 2823890): (1, "GENRE_ONLY"),
    ("seven_automation", 382310): (2, ""),
    ("seven_automation", 3115220): (1, "GENRE_ONLY"),
    ("seven_automation", 4634300): (2, ""),
    ("seven_automation", 507490): (0, "IRRELEVANT"),
    ("seven_automation", 2162800): (3, ""),
    ("seven_automation", 2244130): (2, ""),
    ("seven_automation", 781180): (2, ""),
    ("seven_automation", 313010): (1, "GENRE_ONLY"),
    ("seven_automation", 2825870): (2, ""),
    ("seven_automation", 4402450): (1, "GENRE_ONLY"),
    ("seven_automation", 48240): (2, ""),
    ("seven_automation", 3312130): (3, ""),

    # seven_horror_coop  P@50 0.46
    ("seven_horror_coop", 3004140): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3429890): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 503350): (3, ""),
    ("seven_horror_coop", 3922920): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 2309400): (2, ""),
    ("seven_horror_coop", 1729140): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1234430): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3815750): (2, ""),
    ("seven_horror_coop", 1844060): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 2454890): (2, ""),
    ("seven_horror_coop", 3176060): (3, ""),
    ("seven_horror_coop", 1802330): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1492070): (3, ""),
    ("seven_horror_coop", 57300): (3, ""),
    ("seven_horror_coop", 2208570): (3, ""),
    ("seven_horror_coop", 3059070): (3, ""),
    ("seven_horror_coop", 381210): (3, ""),
    ("seven_horror_coop", 3607770): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3629570): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3967470): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1128140): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1850740): (3, ""),
    ("seven_horror_coop", 1302240): (3, ""),
    ("seven_horror_coop", 644480): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 739630): (3, ""),
    ("seven_horror_coop", 2015650): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 844330): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1926620): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3099190): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 599080): (3, ""),
    ("seven_horror_coop", 1506620): (2, ""),
    ("seven_horror_coop", 2868070): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3645890): (2, ""),
    ("seven_horror_coop", 2487140): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 999220): (3, ""),
    ("seven_horror_coop", 2827200): (3, ""),
    ("seven_horror_coop", 1520380): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1791910): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 2835530): (2, ""),
    ("seven_horror_coop", 221040): (2, ""),
    ("seven_horror_coop", 1065310): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 481110): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3894440): (2, ""),
    ("seven_horror_coop", 2635640): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 696220): (2, ""),
    ("seven_horror_coop", 1785120): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1715730): (2, ""),
    ("seven_horror_coop", 2191180): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 3799320): (1, "GENRE_ONLY"),
    ("seven_horror_coop", 1813170): (1, "GENRE_ONLY"),

    # seven_lowrev_indie  P@50 0.70
    ("seven_lowrev_indie", 1281790): (3, ""),
    ("seven_lowrev_indie", 1444080): (2, ""),
    ("seven_lowrev_indie", 1096180): (3, ""),
    ("seven_lowrev_indie", 493200): (3, ""),
    ("seven_lowrev_indie", 969760): (3, ""),
    ("seven_lowrev_indie", 1290760): (3, ""),
    ("seven_lowrev_indie", 851180): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 115800): (3, ""),
    ("seven_lowrev_indie", 444720): (2, ""),
    ("seven_lowrev_indie", 3870310): (2, ""),
    ("seven_lowrev_indie", 1740300): (3, ""),
    ("seven_lowrev_indie", 2596420): (3, ""),
    ("seven_lowrev_indie", 1098080): (2, ""),
    ("seven_lowrev_indie", 269650): (3, ""),
    ("seven_lowrev_indie", 1489410): (2, ""),
    ("seven_lowrev_indie", 3548000): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 1672810): (3, ""),
    ("seven_lowrev_indie", 331870): (3, ""),
    ("seven_lowrev_indie", 1328840): (3, ""),
    ("seven_lowrev_indie", 1225580): (2, ""),
    ("seven_lowrev_indie", 1634860): (3, ""),
    ("seven_lowrev_indie", 1674780): (3, ""),
    ("seven_lowrev_indie", 1079200): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 347800): (3, ""),
    ("seven_lowrev_indie", 105800): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 454250): (2, ""),
    ("seven_lowrev_indie", 1010950): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 851100): (3, ""),
    ("seven_lowrev_indie", 350070): (3, ""),
    ("seven_lowrev_indie", 2074630): (2, ""),
    ("seven_lowrev_indie", 1495240): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 3047750): (2, ""),
    ("seven_lowrev_indie", 569800): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 628550): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 1911940): (2, ""),
    ("seven_lowrev_indie", 2257790): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 400630): (3, ""),
    ("seven_lowrev_indie", 1384760): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 2573930): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 2071500): (2, ""),
    ("seven_lowrev_indie", 1234180): (1, "GENRE_ONLY"),
    ...
    ("seven_lowrev_indie", 1008920): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 1397000): (1, "GENRE_ONLY"),
    ("seven_lowrev_indie", 2201910): (1, "GENRE_ONLY"),
    ...
    ("ten_cozy", 2495100): (3, ""),
    ("ten_cozy", 2736840): (2, ""),
    ("ten_cozy", 3051050): (1, "GENRE_ONLY"),
    ("ten_cozy", 1077530): (1, "GENRE_ONLY"),
    ("ten_cozy", 2340520): (3, ""),
    ("ten_cozy", 3677420): (2, ""),
    ("ten_cozy", 2285490): (1, "GENRE_ONLY"),
    ("ten_cozy", 1240450): (2, ""),
    ("ten_cozy", 3362960): (2, ""),
    ("ten_cozy", 3017730): (3, ""),
    ("ten_cozy", 3120890): (1, "GENRE_ONLY"),
    ("ten_cozy", 2331880): (2, ""),
    ("ten_cozy", 2508780): (3, ""),
    ("ten_cozy", 1372320): (3, ""),
    ("ten_cozy", 2485350): (2, ""),
    ...
    ("ten_cozy", 3905380): (2, ""),
    ("ten_cozy", 2698420): (2, ""),
    ("ten_cozy", 3565100): (1, "GENRE_ONLY"),
    ("ten_cozy", 2834780): (1, "GENRE_ONLY"),
    ("ten_cozy", 1046030): (3, ""),
    ("ten_cozy", 1592110): (3, ""),
    ("ten_cozy", 2054740): (1, "GENRE_ONLY"),
    ("ten_cozy", 1550010): (2, ""),
    ("ten_cozy", 2715700): (2, ""),
    ("ten_cozy", 3314070): (2, ""),
    ("ten_cozy", 2954460): (1, "GENRE_ONLY"),
    ("ten_cozy", 3609750): (3, ""),
    ("ten_cozy", 1499940): (2, ""),
    ("ten_cozy", 432010): (2, ""),
    ...
    ("ten_jrpg", 3375780): (3, ""),
    ("ten_jrpg", 2570810): (3, ""),
    ("ten_jrpg", 1401730): (1, "GENRE_ONLY"),
    ("ten_jrpg", 1850510): (3, ""),
    ("ten_jrpg", 230230): (1, "GENRE_ONLY"),
    ("ten_jrpg", 921570): (3, ""),
    ("ten_jrpg", 4570720): (2, ""),
    ("ten_jrpg", 1038810): (3, ""),
    ("ten_jrpg", 1480810): (3, ""),
    ...
    ("ten_jrpg", 312540): (3, ""),
    ("ten_jrpg", 349790): (2, ""),
    ("ten_jrpg", 867210): (1, "GENRE_ONLY"),
    ("ten_jrpg", 1450120): (3, ""),
    ("ten_jrpg", 3319980): (3, ""),
    ("ten_jrpg", 2765460): (1, "GENRE_ONLY"),
    ("ten_jrpg", 690140): (2, ""),
    ("ten_jrpg", 1765090): (1, "GENRE_ONLY"),
    ("ten_jrpg", 587100): (3, ""),
    ("ten_jrpg", 691790): (3, ""),
    ("ten_jrpg", 256460): (3, ""),
    ("ten_jrpg", 606370): (3, ""),
    ("ten_jrpg", 2833580): (3, ""),
    ("ten_jrpg", 3201010): (1, "GENRE_ONLY"),
    ("ten_jrpg", 1150690): (3, ""),
    ("ten_jrpg", 1490410): (1, "GENRE_ONLY"),
    ("ten_jrpg", 315860): (3, ""),
    ("ten_jrpg", 1096530): (1, "GENRE_ONLY"),
    ("ten_jrpg", 223810): (3, ""),
    ("ten_jrpg", 1450090): (3, ""),
    ("ten_jrpg", 613830): (3, ""),
    ("ten_jrpg", 609150): (3, ""),
    ...
    ("ten_jrpg", 1897050): (2, ""),
    ("ten_jrpg", 952540): (3, ""),
    ("ten_jrpg", 1105670): (1, "GENRE_ONLY"),
    ("ten_jrpg", 3949290): (3, ""),
    ("ten_jrpg", 1903340): (3, ""),
    ("ten_jrpg", 506510): (3, ""),
    ("ten_jrpg", 435150): (1, "GENRE_ONLY"),

    # ten_mixed_library  P@50 0.90
    ...
    ("ten_mixed_library", 550): (3, ""),
    ("ten_mixed_library", 2244130): (2, ""),
    ("ten_mixed_library", 1902960): (3, ""),
    ("ten_mixed_library", 2736840): (1, "GENRE_ONLY"),
    ("ten_mixed_library", 646570): (3, ""),
    ("ten_mixed_library", 3099190): (1, "GENRE_ONLY"),
    ("ten_mixed_library", 1637320): (3, ""),
    ("ten_mixed_library", 1074180): (1, "GENRE_ONLY"),
    ("ten_mixed_library", 1369630): (3, ""),
    ("ten_mixed_library", 3411020): (2, ""),
    ("ten_mixed_library", 1145360): (3, ""),
    ("ten_mixed_library", 2119590): (2, ""),
    ("ten_mixed_library", 415590): (2, ""),
    ("ten_mixed_library", 548430): (3, ""),
    ("ten_mixed_library", 313010): (2, ""),
    ("ten_mixed_library", 236090): (3, ""),
    ("ten_mixed_library", 2824490): (3, ""),
    ("ten_mixed_library", 2071280): (3, ""),
    ("ten_mixed_library", 252110): (2, ""),
    ("ten_mixed_library", 258970): (2, ""),
    ("ten_mixed_library", 1509510): (2, ""),
    ("ten_mixed_library", 3088070): (1, "GENRE_ONLY"),
    ("ten_mixed_library", 1517970): (3, ""),
    ("ten_mixed_library", 2026820): (3, ""),
    ("ten_mixed_library", 1869780): (2, ""),
    ("ten_mixed_library", 930780): (2, ""),
    ("ten_mixed_library", 2193540): (3, ""),
    ("ten_mixed_library", 579840): (2, ""),
    ("ten_mixed_library", 1987080): (2, ""),
    ("ten_mixed_library", 2198070): (2, ""),
    ("ten_mixed_library", 2871930): (2, ""),
    ("ten_mixed_library", 2097570): (3, ""),
    ("ten_mixed_library", 2555950): (2, ""),
    ("ten_mixed_library", 1520380): (1, "GENRE_ONLY"),
    ("ten_mixed_library", 1250): (3, ""),
    ("ten_mixed_library", 1307890): (3, ""),
    ("ten_mixed_library", 1536620): (2, ""),
    ("ten_mixed_library", 1146230): (2, ""),
    ("ten_mixed_library", 1494260): (2, ""),
    ("ten_mixed_library", 1428470): (2, ""),
    ("ten_mixed_library", 699130): (3, ""),
    ("ten_mixed_library", 1411740): (3, ""),
    ("ten_mixed_library", 2060750): (2, ""),
    ("ten_mixed_library", 1385380): (3, ""),
    ("ten_mixed_library", 2436940): (2, ""),
}


#: 홀드아웃 누수로 시드를 교체한 두 프로필의 재판정 100쌍.
#: 이전 판정은 다른 시드에 대한 것이라 무효라서 지웠다 — 관련성은 시드에 의존한다.
BLIND_SEEDCOUNT_V2 = {
    # five_mixed_acclaimed  P@50 0.42  (시드 교체 후 재판정)
    ...
    ("five_mixed_acclaimed", 1449110): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 842910): (2, ""),
    ("five_mixed_acclaimed", 344480): (2, ""),
    ("five_mixed_acclaimed", 1720090): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1280930): (3, ""),
    ("five_mixed_acclaimed", 1145290): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 105800): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 2081180): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 40800): (3, ""),
    ("five_mixed_acclaimed", 2388460): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1660840): (2, ""),
    ("five_mixed_acclaimed", 355150): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 348430): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1150950): (3, ""),
    ("five_mixed_acclaimed", 340520): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 612740): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 2596420): (3, ""),
    ("five_mixed_acclaimed", 2216120): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 345120): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1835240): (2, ""),
    ("five_mixed_acclaimed", 2842040): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 2241710): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 320820): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1693260): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 2820820): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 883360): (2, ""),
    ("five_mixed_acclaimed", 1224020): (2, ""),
    ("five_mixed_acclaimed", 1454540): (2, ""),
    ("five_mixed_acclaimed", 497780): (3, ""),
    ("five_mixed_acclaimed", 3069320): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1135260): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 552160): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 726320): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 3664230): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 904380): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1620730): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 3446190): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 1162280): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 751640): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 3158260): (1, "GENRE_ONLY"),
    ("five_mixed_acclaimed", 226120): (1, "GENRE_ONLY"),

    # five_walking_sim  P@50 0.50  (시드 교체 후 재판정)
    ("five_walking_sim", 1703340): (3, ""),
    ("five_walking_sim", 355970): (2, ""),
    ("five_walking_sim", 244910): (2, ""),
    ("five_walking_sim", 1295920): (1, "GENRE_ONLY"),
    ("five_walking_sim", 2644520): (1, "GENRE_ONLY"),
    ("five_walking_sim", 1288900): (2, ""),
    ("five_walking_sim", 1057750): (3, ""),
    ("five_walking_sim", 520720): (3, ""),
    ("five_walking_sim", 329830): (2, ""),
    ("five_walking_sim", 2956420): (1, "GENRE_ONLY"),
    ("five_walking_sim", 1126600): (2, ""),
    ("five_walking_sim", 297720): (1, "GENRE_ONLY"),
    ("five_walking_sim", 297350): (2, ""),
    ("five_walking_sim", 1574310): (3, ""),
    ("five_walking_sim", 1572040): (1, "GENRE_ONLY"),
    ("five_walking_sim", 417880): (3, ""),
    ("five_walking_sim", 214700): (3, ""),
    ("five_walking_sim", 3387330): (1, "GENRE_ONLY"),
    ("five_walking_sim", 359040): (1, "GENRE_ONLY"),
    ("five_walking_sim", 1299480): (1, "GENRE_ONLY"),
    ("five_walking_sim", 2852930): (1, "GENRE_ONLY"),
    ("five_walking_sim", 27000): (2, ""),
    ("five_walking_sim", 3364880): (1, "GENRE_ONLY"),
    ("five_walking_sim", 402040): (1, "GENRE_ONLY"),
    ("five_walking_sim", 714120): (3, ""),
    ("five_walking_sim", 2458980): (1, "GENRE_ONLY"),
    ("five_walking_sim", 648100): (2, ""),
    ("five_walking_sim", 323380): (2, ""),
    ("five_walking_sim", 501300): (3, ""),
    ("five_walking_sim", 1637300): (1, "GENRE_ONLY"),
    ("five_walking_sim", 2229350): (1, "GENRE_ONLY"),
    ("five_walking_sim", 2961530): (2, ""),
    ("five_walking_sim", 1901970): (1, "GENRE_ONLY"),
    ("five_walking_sim", 581370): (1, "GENRE_ONLY"),
    ("five_walking_sim", 2527500): (2, ""),
    ("five_walking_sim", 1193990): (1, "GENRE_ONLY"),
    ("five_walking_sim", 253110): (2, ""),
    ("five_walking_sim", 1484580): (1, "GENRE_ONLY"),
    ("five_walking_sim", 1242910): (1, "GENRE_ONLY"),
    ("five_walking_sim", 3047750): (2, ""),
    ("five_walking_sim", 3257490): (1, "GENRE_ONLY"),
    ("five_walking_sim", 368430): (2, ""),
    ("five_walking_sim", 558450): (1, "GENRE_ONLY"),
    ("five_walking_sim", 303210): (3, ""),
    ("five_walking_sim", 427660): (1, "GENRE_ONLY"),
    ("five_walking_sim", 1319420): (1, "GENRE_ONLY"),
    ("five_walking_sim", 696480): (2, ""),
    ("five_walking_sim", 3440140): (1, "GENRE_ONLY"),
...
# DISLIKE 시나리오 측정 중 노출된 2쌍 (coh_openworld_survival 문맥).
BLIND_DISLIKE = {
    ("coh_openworld_survival", 298610): (2, ""),  # Ylands — 샌드박스 탐험 제작
    ("coh_openworld_survival", 327860): (2, ""),  # Salt — 오픈월드 항해 탐험
}


# 신규 8개 프로필(2시드 3 / 갭축 3 / 대형 라이브러리 2) k=100 블라인드 판정.
# 제품 설정(page_size=10, hub 0.35, ssf 0.001, series session cap 5)으로 뽑은 슬롯.
BLIND_NEW8 = {
    ...
    ("two_bigaction", 1045180): (1, ""),
    ("two_bigaction", 644830): (2, ""),
    ("two_bigaction", 2570810): (2, ""),
    ("two_bigaction", 2075100): (2, ""),
    ("two_bigaction", 2406680): (1, ""),
    ("two_bigaction", 1731070): (3, ""),
    ("two_bigaction", 1997660): (2, ""),
    ("two_bigaction", 1491410): (3, ""),
    ...
    ("two_bigaction", 2561580): (1, ""),
    ("two_bigaction", 2244210): (2, ""),
    ("two_bigaction", 609150): (1, ""),
    ("two_bigaction", 755500): (2, ""),
    ("two_bigaction", 1771300): (3, ""),
    ("two_bigaction", 582160): (3, ""),
    ("two_bigaction", 2258500): (2, ""),
    ("two_bigaction", 1680880): (3, ""),
    ("two_bigaction", 2725260): (1, ""),
    ("two_bigaction", 1314000): (2, ""),
    ("two_bigaction", 831050): (1, ""),
    ("two_bigaction", 1453790): (1, ""),
    ("two_bigaction", 1111930): (1, ""),
    ("two_bigaction", 1442450): (1, ""),
    ("two_bigaction", 2765460): (1, ""),
    ("two_bigaction", 1194610): (1, ""),
    ("two_bigaction", 1013140): (2, ""),
    ("two_bigaction", 211160): (1, ""),
    ("two_bigaction", 1238020): (3, ""),
    ("two_bigaction", 2215430): (3, ""),
    ("two_bigaction", 1963210): (2, ""),
    ("two_bigaction", 618100): (1, ""),
    ("two_bigaction", 411300): (2, ""),
    ("two_bigaction", 1663640): (1, ""),
    ("two_bigaction", 1989320): (2, ""),
    ("two_bigaction", 1954200): (3, ""),
    ("two_bigaction", 2515020): (3, ""),
    ("two_bigaction", 1154030): (2, ""),
    ("two_bigaction", 899770): (1, ""),
    ("two_bigaction", 3074020): (1, ""),
    ("two_bigaction", 740130): (2, ""),
    ("two_bigaction", 1189290): (1, ""),
    ("two_bigaction", 750920): (3, ""),
    ("two_bigaction", 2003050): (1, ""),
    ("two_bigaction", 3843530): (1, ""),
    ("two_bigaction", 801800): (2, ""),
    ("two_bigaction", 536270): (1, ""),
    ("two_bigaction", 2877540): (1, ""),
    ("two_bigaction", 1479810): (1, ""),
    ("two_bigaction", 418180): (1, ""),
    ("two_bigaction", 40390): (2, ""),
    ("two_bigaction", 2382520): (1, ""),
    ("two_bigaction", 2358720): (3, ""),
    ("two_bigaction", 1601740): (1, ""),
    ("two_bigaction", 1132980): (1, ""),
    ("two_bigaction", 279070): (1, ""),
    ("two_bigaction", 2473480): (2, ""),
    ("two_bigaction", 351100): (1, ""),
    ("two_bigaction", 977880): (1, ""),
    ("two_bigaction", 1850570): (3, ""),
    ("two_bigaction", 1449110): (2, ""),
    ("two_bigaction", 48190): (2, ""),
    ("two_bigaction", 268670): (1, ""),
    ("two_bigaction", 367500): (3, ""),
    ("two_bigaction", 788270): (1, ""),
    ("two_bigaction", 1013910): (1, ""),
    ("two_bigaction", 369440): (1, ""),
    ("two_bigaction", 1203620): (1, ""),
    ("two_bigaction", 2924170): (1, ""),
    ("two_bigaction", 830370): (1, ""),
    ("two_bigaction", 2767530): (1, ""),
    ("two_bigaction", 1108590): (1, ""),
    ("two_bigaction", 2186990): (2, ""),
    ("two_bigaction", 210950): (1, ""),
    ("two_bigaction", 1164690): (1, ""),
    ("two_bigaction", 391220): (3, ""),
    ("two_bigaction", 1579340): (1, ""),
    ("two_bigaction", 1805320): (1, ""),
    ("two_bigaction", 531660): (1, ""),
    ("two_bigaction", 386280): (1, ""),
    ("two_bigaction", 1401730): (2, ""),
    ("two_bigaction", 846770): (2, ""),
    ("two_bigaction", 40300): (2, ""),
    ("two_bigaction", 379430): (3, ""),
    ("two_bigaction", 2409110): (1, ""),
    ("two_bigaction", 1206410): (1, ""),
    ("two_rhythm_arcade", 1812560): (3, ""),
    ("two_rhythm_arcade", 1643590): (3, ""),
    ("two_rhythm_arcade", 293780): (1, ""),
    ("two_rhythm_arcade", 405290): (1, ""),
    ("two_rhythm_arcade", 238280): (1, ""),
    ("two_rhythm_arcade", 774181): (3, ""),
    ("two_rhythm_arcade", 539400): (1, ""),
    ("two_rhythm_arcade", 204360): (1, ""),
    ("two_rhythm_arcade", 1608700): (3, ""),
    ("two_rhythm_arcade", 440310): (3, ""),
    ("two_rhythm_arcade", 2073250): (3, ""),
    ("two_rhythm_arcade", 49600): (3, ""),
    ("two_rhythm_arcade", 314410): (1, ""),
    ("two_rhythm_arcade", 2949320): (3, ""),
    ("two_rhythm_arcade", 258970): (1, ""),
    ("two_rhythm_arcade", 1072640): (3, ""),
    ("two_rhythm_arcade", 2015270): (1, ""),
    ("two_rhythm_arcade", 3003460): (1, ""),
    ("two_rhythm_arcade", 2235200): (1, ""),
    ("two_rhythm_arcade", 4737700): (2, ""),
    ("two_rhythm_arcade", 2543510): (1, ""),
    ("two_rhythm_arcade", 24240): (0, ""),
    ("two_rhythm_arcade", 655740): (1, ""),
    ("two_rhythm_arcade", 368570): (3, ""),
    ("two_rhythm_arcade", 311690): (2, ""),
    ("two_rhythm_arcade", 2984520): (3, ""),
    ("two_rhythm_arcade", 239070): (1, ""),
    ("two_rhythm_arcade", 2423300): (0, ""),
    ("two_rhythm_arcade", 3892270): (0, ""),
    ("two_rhythm_arcade", 1092630): (1, ""),
    ("two_rhythm_arcade", 340520): (1, ""),
    ("two_rhythm_arcade", 290690): (1, ""),
    ("two_rhythm_arcade", 2480590): (1, ""),
    ("two_rhythm_arcade", 1284550): (2, ""),
    ("two_rhythm_arcade", 489260): (1, ""),
    ("two_rhythm_arcade", 618740): (3, ""),
    ("two_rhythm_arcade", 3053950): (1, ""),
    ("two_rhythm_arcade", 579840): (1, ""),
    ("two_rhythm_arcade", 452060): (1, ""),
    ("two_rhythm_arcade", 1264880): (0, ""),
    ("two_rhythm_arcade", 1833200): (0, ""),
    ("two_rhythm_arcade", 4249380): (3, ""),
    ("two_rhythm_arcade", 373290): (1, ""),
    ("two_rhythm_arcade", 244810): (1, ""),
    ("two_rhythm_arcade", 2605790): (0, ""),
    ("two_rhythm_arcade", 2951580): (3, ""),
    ("two_rhythm_arcade", 1927380): (1, ""),
    ("two_rhythm_arcade", 985890): (2, ""),
    ("two_rhythm_arcade", 853450): (0, ""),
    ("two_rhythm_arcade", 350910): (1, ""),
    ("two_rhythm_arcade", 1278290): (1, ""),
    ("two_rhythm_arcade", 774801): (1, ""),
    ("two_rhythm_arcade", 445980): (1, ""),
    ("two_rhythm_arcade", 2397250): (1, ""),
    ("two_rhythm_arcade", 416790): (3, ""),
    ("two_rhythm_arcade", 2444750): (1, ""),
    ("two_rhythm_arcade", 2620240): (0, ""),
    ("two_rhythm_arcade", 1064610): (3, ""),
    ("two_rhythm_arcade", 2116260): (1, ""),
    ("two_rhythm_arcade", 329490): (1, ""),
    ("two_rhythm_arcade", 3108510): (0, ""),
    ("two_rhythm_arcade", 2904000): (1, ""),
    ("two_rhythm_arcade", 1672970): (1, ""),
    ("two_rhythm_arcade", 2436350): (3, ""),
    ("two_rhythm_arcade", 383230): (1, ""),
    ("two_rhythm_arcade", 1509960): (1, ""),
    ("two_rhythm_arcade", 548430): (0, ""),
    ("two_rhythm_arcade", 418530): (1, ""),
    ("two_rhythm_arcade", 587520): (0, ""),
    ("two_rhythm_arcade", 2960490): (1, ""),
    ("two_rhythm_arcade", 361300): (1, ""),
    ("two_rhythm_arcade", 239350): (1, ""),
    ("two_rhythm_arcade", 2717010): (3, ""),
    ("two_rhythm_arcade", 1243890): (1, ""),
    ("two_rhythm_arcade", 2225960): (1, ""),
    ("two_rhythm_arcade", 538390): (0, ""),
    ("two_rhythm_arcade", 1492070): (0, ""),
    ("two_rhythm_arcade", 1721110): (0, ""),
    ("two_rhythm_arcade", 1662570): (0, ""),
    ("two_rhythm_arcade", 1077450): (1, ""),
    ("two_rhythm_arcade", 3302150): (2, ""),
    ("two_rhythm_arcade", 2263360): (3, ""),
    ("two_rhythm_arcade", 2516170): (1, ""),
    ("two_rhythm_arcade", 1765310): (1, ""),
    ("two_rhythm_arcade", 4050610): (0, ""),
    ("two_rhythm_arcade", 229480): (1, ""),
    ("two_rhythm_arcade", 903910): (1, ""),
    ("two_rhythm_arcade", 290040): (1, ""),
    ("two_rhythm_arcade", 4694100): (2, ""),
    ("two_rhythm_arcade", 371970): (0, ""),
    ("two_rhythm_arcade", 3693720): (3, ""),
    ("two_rhythm_arcade", 1893440): (1, ""),
    ("two_rhythm_arcade", 3683850): (1, ""),
    ("two_rhythm_arcade", 2507980): (1, ""),
    ("two_rhythm_arcade", 2250500): (3, ""),
    ("two_rhythm_arcade", 496290): (0, ""),
    ("two_rhythm_arcade", 3513600): (0, ""),
    ("two_rhythm_arcade", 1286350): (3, ""),
    ("two_rhythm_arcade", 790740): (0, ""),
    ("two_rhythm_arcade", 2996040): (1, ""),
    ...
    ("two_cozy_puzzle", 385250): (2, ""),
    ("two_cozy_puzzle", 1473050): (1, ""),
    ("two_cozy_puzzle", 1786820): (1, ""),
    ("two_cozy_puzzle", 2191190): (1, ""),
    ("two_cozy_puzzle", 2348100): (2, ""),
    ("two_cozy_puzzle", 1480120): (1, ""),
    ("two_cozy_puzzle", 2207440): (3, ""),
    ("two_cozy_puzzle", 2834330): (2, ""),
    ("two_cozy_puzzle", 3791540): (1, ""),
    ("two_cozy_puzzle", 2101390): (3, ""),
    ("two_cozy_puzzle", 1927150): (2, ""),
    ("two_cozy_puzzle", 3346300): (1, ""),
    ("two_cozy_puzzle", 568320): (2, ""),
    ("two_cozy_puzzle", 2702260): (3, ""),
    ("two_cozy_puzzle", 3759870): (1, ""),
    ("two_cozy_puzzle", 1522560): (1, ""),
    ("two_cozy_puzzle", 3219450): (1, ""),
    ("two_cozy_puzzle", 2450840): (3, ""),
    ("two_cozy_puzzle", 2464090): (1, ""),
    ("two_cozy_puzzle", 37600): (2, ""),
    ("two_cozy_puzzle", 367580): (3, ""),
    ("two_cozy_puzzle", 1602560): (2, ""),
    ("two_cozy_puzzle", 1333910): (3, ""),
    ("two_cozy_puzzle", 3130800): (2, ""),
    ("two_cozy_puzzle", 1240210): (2, ""),
    ("two_cozy_puzzle", 1549030): (1, ""),
    ("two_cozy_puzzle", 1629520): (3, ""),
    ("two_cozy_puzzle", 2596420): (3, ""),
    ("two_cozy_puzzle", 936020): (1, ""),
    ("two_cozy_puzzle", 1961520): (1, ""),
    ("two_cozy_puzzle", 2345470): (1, ""),
    ("two_cozy_puzzle", 1075200): (2, ""),
    ("two_cozy_puzzle", 467210): (2, ""),
    ("two_cozy_puzzle", 567030): (2, ""),
    ("two_cozy_puzzle", 1097100): (3, ""),
    ("two_cozy_puzzle", 1766790): (1, ""),
    ...
    ("two_cozy_puzzle", 966000): (1, ""),
    ("two_cozy_puzzle", 1471960): (2, ""),
    ("two_cozy_puzzle", 3915270): (1, ""),
    ("two_cozy_puzzle", 2492390): (2, ""),
    ("two_cozy_puzzle", 3550240): (1, ""),
    ("two_cozy_puzzle", 1149660): (0, ""),
    ("two_cozy_puzzle", 3707120): (1, ""),
    ("two_cozy_puzzle", 476460): (1, ""),
    ("two_cozy_puzzle", 3371710): (2, ""),
    ("two_cozy_puzzle", 581760): (0, ""),
    ("two_cozy_puzzle", 3530160): (1, ""),
    ("two_cozy_puzzle", 2367190): (1, ""),
    ("two_cozy_puzzle", 3444050): (1, ""),
    ("two_cozy_puzzle", 1060670): (0, ""),
    ...
    ("coh_sports", 3219190): (1, ""),
    ("coh_sports", 1665460): (2, ""),
    ...
    ("coh_sports", 2477010): (0, ""),
    ("coh_sports", 3514580): (1, ""),
    ("coh_sports", 703940): (1, ""),
    ("coh_sports", 3613730): (0, ""),
    ("coh_sports", 2669320): (3, ""),
    ("coh_sports", 3540900): (1, ""),
    ("coh_sports", 2988140): (2, ""),
    ("coh_sports", 1488560): (1, ""),
    ("coh_sports", 2819400): (2, ""),
    ("coh_sports", 2157560): (0, ""),
    ("coh_sports", 1701380): (2, ""),
    ("coh_sports", 4069520): (1, ""),
    ("coh_sports", 2399420): (2, ""),
    ("coh_sports", 2337630): (2, ""),
    ("coh_sports", 3468650): (2, ""),
    ("coh_sports", 2581700): (2, ""),
    ("coh_sports", 946880): (1, ""),
    ("coh_sports", 1799930): (1, ""),
    ("coh_sports", 834280): (1, ""),
    ("coh_sports", 932980): (1, ""),
    ("coh_sports", 1092050): (0, ""),
    ("coh_sports", 1126990): (2, ""),
    ("coh_sports", 1281170): (1, ""),
    ("coh_sports", 3013260): (1, ""),
    ("coh_sports", 1174460): (1, ""),
    ("coh_sports", 2358260): (2, ""),
    ("coh_sports", 3249490): (1, ""),
    ("coh_sports", 2730810): (3, ""),
    ("coh_sports", 4032350): (3, ""),
    ("coh_sports", 4558300): (1, ""),
    ("coh_sports", 1324350): (1, ""),
    ("coh_sports", 1475850): (2, ""),
    ("coh_sports", 2814560): (1, ""),
    ("coh_sports", 316700): (1, ""),
    ("coh_sports", 2459100): (1, ""),
    ("coh_sports", 891020): (2, ""),
    ("coh_sports", 750470): (0, ""),
    ("coh_sports", 2488620): (2, ""),
    ("coh_sports", 692030): (2, ""),
    ("coh_sports", 794860): (1, ""),
    ("coh_sports", 554750): (1, ""),
    ("coh_sports", 2914390): (1, ""),
    ("coh_sports", 859660): (1, ""),
    ("coh_sports", 1453850): (2, ""),
    ("coh_sports", 3297370): (1, ""),
    ("coh_sports", 3734990): (2, ""),
    ("coh_sports", 321400): (1, ""),
    ("coh_sports", 2574120): (2, ""),
    ("coh_sports", 2151290): (2, ""),
    ("coh_sports", 2310130): (1, ""),
    ("coh_sports", 431240): (2, ""),
    ("coh_sports", 3132160): (1, ""),
    ("coh_sports", 1392560): (1, ""),
    ("coh_sports", 1345760): (2, ""),
    ("coh_sports", 3920720): (1, ""),
    ...
    ("coh_sports", 996620): (1, ""),
    ("coh_sports", 380600): (1, ""),
    ("coh_sports", 1028630): (2, ""),
    ("coh_sports", 2237700): (1, ""),
    ("coh_sports", 1196470): (2, ""),
    ("coh_sports", 1595050): (2, ""),
    ("coh_sports", 2364570): (0, ""),
    ("coh_sports", 366690): (1, ""),
    ("coh_sports", 1951410): (2, ""),
    ("coh_sports", 299970): (2, ""),
    ("coh_sports", 1412780): (1, ""),
    ("coh_sports", 1086410): (1, ""),
    ("coh_sports", 1289670): (0, ""),
    ("coh_sports", 365960): (2, ""),
    ("coh_sports", 1415920): (1, ""),
    ("coh_sports", 346470): (1, ""),
    ("coh_sports", 1443330): (1, ""),
    ("coh_sports", 4128400): (2, ""),
    ("coh_sports", 571740): (2, ""),
    ("coh_sports", 1952920): (1, ""),
    ("coh_sports", 2494340): (2, ""),
    ("coh_sports", 501190): (1, ""),
    ...
    ("six_action_adv", 2321880): (0, ""),
    ("six_action_adv", 371660): (2, ""),
    ("six_action_adv", 8000): (2, ""),
    ("six_action_adv", 1099220): (1, ""),
    ("six_action_adv", 911400): (3, ""),
    ("six_action_adv", 280180): (1, ""),
    ("six_action_adv", 460930): (2, ""),
    ("six_action_adv", 1491410): (2, ""),
    ("six_action_adv", 248470): (0, ""),
    ("six_action_adv", 15750): (2, ""),
    ("six_action_adv", 311800): (0, ""),
    ("six_action_adv", 1013140): (2, ""),
    ("six_action_adv", 225000): (1, ""),
    ("six_action_adv", 201870): (3, ""),
    ("six_action_adv", 935580): (0, ""),
    ("six_action_adv", 668580): (2, ""),
    ("six_action_adv", 606980): (1, ""),
    ("six_action_adv", 952060): (3, ""),
    ("six_action_adv", 844260): (1, ""),
    ("six_action_adv", 1622350): (3, ""),
    ("six_action_adv", 1368030): (2, ""),
    ("six_action_adv", 313120): (1, ""),
    ("six_action_adv", 224960): (1, ""),
    ("six_action_adv", 1205040): (0, ""),
    ("six_action_adv", 7520): (1, ""),
    ("six_action_adv", 914290): (0, ""),
    ("six_action_adv", 1795180): (0, ""),
    ("six_action_adv", 28000): (2, ""),
    ("six_action_adv", 2377450): (1, ""),
    ("six_action_adv", 1111930): (0, ""),
    ("six_action_adv", 204450): (2, ""),
    ("six_action_adv", 541300): (1, ""),
    ("six_action_adv", 4046590): (1, ""),
    ("six_action_adv", 1488810): (0, ""),
    ("six_action_adv", 205100): (3, ""),
    ("six_action_adv", 3646460): (1, ""),
    ("six_action_adv", 534380): (3, ""),
    ("six_action_adv", 1182900): (3, ""),
    ("six_action_adv", 1590660): (0, ""),
    ("six_action_adv", 285190): (0, ""),
    ("six_action_adv", 1245620): (3, ""),
    ("six_action_adv", 536270): (2, ""),
    ("six_action_adv", 225320): (1, ""),
    ("six_action_adv", 399890): (0, ""),
    ("six_action_adv", 9010): (1, ""),
    ("six_action_adv", 471010): (1, ""),
    ("six_action_adv", 265550): (2, ""),
    ("six_action_adv", 46480): (1, ""),
    ("six_action_adv", 1699230): (2, ""),
    ("six_action_adv", 110800): (3, ""),
    ("six_action_adv", 6920): (1, ""),
    ("six_action_adv", 3321460): (3, ""),
    ("six_action_adv", 46500): (1, ""),
    ("six_action_adv", 330990): (0, ""),
    ("six_action_adv", 814380): (3, ""),
    ("six_action_adv", 2765460): (0, ""),
    ("six_action_adv", 1343520): (0, ""),
    ("six_action_adv", 318600): (1, ""),
    ("six_action_adv", 2336440): (1, ""),
    ("six_action_adv", 3366780): (1, ""),
    ("six_action_adv", 337000): (3, ""),
    ("twenty_broad", 538100): (2, ""),
    ("twenty_broad", 768200): (2, ""),
    ("twenty_broad", 3894440): (1, ""),
    ("twenty_broad", 219740): (3, ""),
    ("twenty_broad", 930780): (2, ""),
    ("twenty_broad", 397540): (3, ""),
    ("twenty_broad", 2881650): (2, ""),
    ("twenty_broad", 1446780): (3, ""),
    ("twenty_broad", 261570): (1, ""),
    ("twenty_broad", 22370): (3, ""),
    ("twenty_broad", 1671210): (3, ""),
    ("twenty_broad", 340050): (1, ""),
    ("twenty_broad", 374320): (3, ""),
    ("twenty_broad", 17710): (1, ""),
    ("twenty_broad", 3408110): (0, ""),
    ("twenty_broad", 2204170): (1, ""),
    ("twenty_broad", 2661300): (2, ""),
    ("twenty_broad", 378370): (0, ""),
    ("twenty_broad", 503350): (2, ""),
    ("twenty_broad", 360170): (2, ""),
    ("twenty_broad", 1515640): (1, ""),
    ("twenty_broad", 2246340): (3, ""),
    ("twenty_broad", 1716740): (2, ""),
    ("twenty_broad", 2221490): (2, ""),
    ("twenty_broad", 1286680): (3, ""),
    ("twenty_broad", 1579340): (1, ""),
    ("twenty_broad", 1245620): (3, ""),
    ("twenty_broad", 4920): (1, ""),
    ("twenty_broad", 1229380): (3, ""),
    ("twenty_broad", 751640): (1, ""),
    ("twenty_broad", 910490): (1, ""),
    ("twenty_broad", 518790): (1, ""),
    ("twenty_broad", 553850): (3, ""),
    ("twenty_broad", 22300): (1, ""),
    ("twenty_broad", 1286710): (2, ""),
    ("twenty_broad", 269270): (2, ""),
    ("twenty_broad", 1635450): (1, ""),
    ("twenty_broad", 962130): (2, ""),
    ("twenty_broad", 623340): (0, ""),
    ("twenty_broad", 644480): (0, ""),
    ("twenty_broad", 3065800): (3, ""),
    ("twenty_broad", 1288320): (1, ""),
    ("twenty_broad", 531660): (0, ""),
    ("twenty_broad", 107100): (3, ""),
    ("twenty_broad", 280520): (2, ""),
    ("twenty_broad", 104900): (1, ""),
    ("twenty_broad", 1250): (2, ""),
    ("twenty_broad", 2868840): (3, ""),
    ("twenty_broad", 230410): (2, ""),
    ("twenty_broad", 786450): (0, ""),
    ("twenty_broad", 1504570): (1, ""),
    ("twenty_broad", 376210): (1, ""),
    ("twenty_broad", 1889640): (0, ""),
    ("twenty_broad", 108600): (3, ""),
    ("twenty_broad", 2235200): (2, ""),
    ("twenty_broad", 1076200): (3, ""),
    ("twenty_broad", 2795540): (1, ""),
    ("twenty_broad", 3105890): (1, ""),
    ("twenty_broad", 2835110): (1, ""),
    ("twenty_broad", 333930): (0, ""),
    ("twenty_broad", 1385380): (3, ""),
    ("twenty_broad", 2075100): (1, ""),
    ("twenty_broad", 365590): (2, ""),
    ("twenty_broad", 3234720): (0, ""),
    ("twenty_broad", 1058020): (1, ""),
    ("twenty_broad", 1488560): (0, ""),
    ("twenty_broad", 895400): (1, ""),
    ("twenty_broad", 897450): (2, ""),
    ("twenty_broad", 2208570): (1, ""),
    ("twenty_broad", 221100): (2, ""),
    ("twenty_broad", 3247750): (2, ""),
    ("twenty_broad", 3100370): (2, ""),
    ("twenty_broad", 788270): (1, ""),
    ("twenty_broad", 324800): (2, ""),
    ("twenty_broad", 1547670): (0, ""),
    ("twenty_broad", 3494520): (1, ""),
    ("twenty_broad", 70600): (1, ""),
    ("twenty_broad", 1169040): (3, ""),
    ("twenty_broad", 876650): (2, ""),
    ("twenty_broad", 1556100): (2, ""),
    ("twenty_broad", 386180): (0, ""),
    ("twenty_broad", 280790): (1, ""),
    ("twenty_broad", 313120): (2, ""),
    ("twenty_broad", 1492070): (1, ""),
    ("twenty_broad", 541300): (1, ""),
    ("twenty_broad", 2157830): (2, ""),
    ("twenty_broad", 2097570): (3, ""),
    ("twenty_broad", 626690): (1, ""),
    ("twenty_broad", 414740): (1, ""),
    ("twenty_broad", 2000950): (1, ""),
    ("twenty_broad", 2537010): (0, ""),
    ("twenty_broad", 224260): (1, ""),
    ("twenty_broad", 1815530): (1, ""),
    ("twenty_broad", 1394130): (1, ""),
    ("twenty_broad", 7520): (0, ""),
    ("twenty_broad", 394510): (2, ""),
    ("twenty_broad", 877010): (1, ""),
    ("twenty_broad", 361420): (2, ""),
    ("twenty_broad", 1520380): (0, ""),
    ("twenty_broad", 495420): (2, ""),
}


# 43프로필 k=100 제품 슬롯 중 기존 판정에 없던 21쌍(코퍼스/캡 변경으로 새로 올라온 자리).
BLIND_FILL43 = {
    ("coh_indie_platformer", 341500): (2, ''),
    ("coh_indie_platformer", 345120): (1, 'LOW_QUALITY'),
    ("coh_indie_platformer", 454100): (1, 'LOW_QUALITY'),
    ("coh_indie_platformer", 458710): (0, 'IRRELEVANT'),
    ("coh_indie_platformer", 764790): (3, ''),
    ("coh_indie_platformer", 396640): (2, ''),
    ("coh_indie_platformer", 688130): (1, 'GENRE_ONLY'),
    ("coh_cozy", 405710): (3, ''),
    ("coh_cozy", 313120): (2, ''),
    ("coh_cozy", 538100): (2, ''),
    ("coh_cozy", 382310): (2, ''),
    ("coh_cozy", 220260): (1, 'GENRE_ONLY'),
    ("coh_cozy", 304950): (3, ''),
    ("coh_cozy", 253250): (2, ''),
    ("coh_cozy", 346110): (1, 'MODE_MISMATCH'),
    ("coh_cozy", 432010): (3, ''),
    ("coh_classic_multi", 1250): (3, ''),
    ("coh_classic_multi", 590830): (3, ''),
    ("coh_classic_multi", 500): (3, ''),
    ("coh_classic_multi", 70600): (1, 'GENRE_ONLY'),
    ("coh_classic_multi", 17710): (2, ''),
}


# 2시드 프로필에 max 집계를 적용한 변형에서 새로 올라온 127칸.
BLIND_TWOMAX = {
    ("two_bigaction", 2407270): (2, ''),
    ("two_bigaction", 925570): (1, ''),
    ("two_bigaction", 524220): (3, ''),
    ("two_bigaction", 1949030): (1, ''),
    ("two_bigaction", 1557480): (1, ''),
    ("two_bigaction", 1351630): (2, ''),
    ("two_bigaction", 2623190): (3, ''),
    ("two_bigaction", 1932680): (1, ''),
    ("two_bigaction", 2221920): (3, ''),
    ("two_bigaction", 1683100): (1, ''),
    ("two_bigaction", 364510): (0, ''),
    ("two_bigaction", 691280): (1, ''),
    ("two_bigaction", 863590): (0, ''),
    ("two_bigaction", 2450450): (1, ''),
    ("two_bigaction", 814380): (3, ''),
    ("two_bigaction", 2362060): (2, ''),
    ("two_bigaction", 2535440): (2, ''),
    ("two_bigaction", 3238670): (1, ''),
    ("two_bigaction", 751060): (0, ''),
    ("two_bigaction", 1121420): (1, ''),
    ("two_bigaction", 1036740): (0, ''),
    ("two_bigaction", 3108510): (1, ''),
    ("two_bigaction", 380750): (1, ''),
    ("two_bigaction", 3004100): (2, ''),
    ("two_bigaction", 900040): (2, ''),
    ("two_bigaction", 1583500): (0, ''),
    ("two_bigaction", 2530980): (2, ''),
    ("two_bigaction", 1377700): (1, ''),
    ("two_bigaction", 1453940): (0, ''),
    ("two_bigaction", 2850110): (0, ''),
    ("two_bigaction", 338390): (2, ''),
    ("two_rhythm_arcade", 1692400): (1, ''),
    ("two_rhythm_arcade", 840620): (1, ''),
    ("two_rhythm_arcade", 2852980): (0, ''),
    ("two_rhythm_arcade", 1769170): (0, ''),
    ("two_rhythm_arcade", 1484280): (0, ''),
    ("two_rhythm_arcade", 1174430): (1, ''),
    ("two_rhythm_arcade", 1786830): (1, ''),
    ("two_rhythm_arcade", 370480): (1, ''),
    ("two_rhythm_arcade", 1350080): (3, ''),
    ("two_rhythm_arcade", 3140180): (0, ''),
    ("two_rhythm_arcade", 310790): (2, ''),
    ("two_rhythm_arcade", 553310): (2, ''),
    ("two_rhythm_arcade", 471220): (1, ''),
    ("two_rhythm_arcade", 905340): (1, ''),
    ("two_rhythm_arcade", 1783180): (2, ''),
    ("two_rhythm_arcade", 937530): (0, ''),
    ("two_rhythm_arcade", 274560): (1, ''),
    ("two_rhythm_arcade", 3030720): (0, ''),
    ("two_rhythm_arcade", 20820): (2, ''),
    ("two_rhythm_arcade", 2143030): (0, ''),
    ("two_rhythm_arcade", 6120): (1, ''),
    ("two_rhythm_arcade", 3098170): (0, ''),
    ("two_rhythm_arcade", 1494260): (0, ''),
    ("two_rhythm_arcade", 588200): (3, ''),
    ("two_rhythm_arcade", 4015080): (2, ''),
    ("two_rhythm_arcade", 1141220): (0, ''),
    ("two_rhythm_arcade", 809020): (2, ''),
    ("two_rhythm_arcade", 329320): (2, ''),
    ("two_rhythm_arcade", 1918130): (0, ''),
    ("two_rhythm_arcade", 770100): (0, ''),
    ("two_rhythm_arcade", 915460): (2, ''),
    ("two_rhythm_arcade", 1145350): (1, ''),
    ("two_rhythm_arcade", 1105570): (0, ''),
    ("two_rhythm_arcade", 2793380): (0, ''),
    ("two_rhythm_arcade", 2146610): (0, ''),
    ("two_rhythm_arcade", 2516550): (0, ''),
    ("two_rhythm_arcade", 3148360): (1, ''),
    ("two_rhythm_arcade", 4517700): (0, ''),
    ("two_rhythm_arcade", 418620): (1, ''),
    ("two_rhythm_arcade", 359280): (0, ''),
    ("two_rhythm_arcade", 384200): (0, ''),
    ("two_rhythm_arcade", 2374670): (0, ''),
    ("two_rhythm_arcade", 359840): (0, ''),
    ("two_rhythm_arcade", 375480): (0, ''),
    ("two_rhythm_arcade", 271570): (0, ''),
    ("two_rhythm_arcade", 234490): (2, ''),
    ("two_cozy_puzzle", 2423270): (3, ''),
    ("two_cozy_puzzle", 4380870): (3, ''),
    ("two_cozy_puzzle", 2274420): (2, ''),
    ("two_cozy_puzzle", 1212620): (0, ''),
    ("two_cozy_puzzle", 1954020): (1, ''),
    ("two_cozy_puzzle", 852090): (3, ''),
    ("two_cozy_puzzle", 2594580): (3, ''),
    ("two_cozy_puzzle", 3170700): (1, ''),
    ("two_cozy_puzzle", 2600140): (3, ''),
    ("two_cozy_puzzle", 1460610): (2, ''),
    ("two_cozy_puzzle", 1199660): (1, ''),
    ("two_cozy_puzzle", 1158910): (1, ''),
    ("two_cozy_puzzle", 57200): (1, ''),
    ("two_cozy_puzzle", 3142900): (1, ''),
    ("two_cozy_puzzle", 4575650): (2, ''),
    ("two_cozy_puzzle", 491220): (1, ''),
    ("two_cozy_puzzle", 2093900): (2, ''),
    ("two_cozy_puzzle", 3227640): (2, ''),
    ("two_cozy_puzzle", 1605190): (1, ''),
    ("two_cozy_puzzle", 1573750): (1, ''),
    ("two_cozy_puzzle", 2188660): (1, ''),
    ("two_cozy_puzzle", 552160): (1, ''),
    ("two_cozy_puzzle", 1094680): (2, ''),
    ("two_cozy_puzzle", 1619230): (3, ''),
    ("two_cozy_puzzle", 1656850): (1, ''),
    ("two_cozy_puzzle", 265890): (2, ''),
    ("two_cozy_puzzle", 941630): (1, ''),
    ("two_cozy_puzzle", 2244440): (1, ''),
    ("two_cozy_puzzle", 344480): (2, ''),
    ("two_cozy_puzzle", 2871440): (3, ''),
    ("two_cozy_puzzle", 1853410): (2, ''),
    ("two_cozy_puzzle", 2999280): (1, ''),
    ("two_cozy_puzzle", 1299960): (1, ''),
    ("two_cozy_puzzle", 551110): (1, ''),
    ("two_cozy_puzzle", 2333240): (2, ''),
    ("two_cozy_puzzle", 3344000): (1, ''),
    ("two_cozy_puzzle", 750290): (2, ''),
    ("two_cozy_puzzle", 2490240): (1, ''),
    ("two_cozy_puzzle", 1148510): (0, ''),
    ("two_cozy_puzzle", 2060790): (2, ''),
    ("two_cozy_puzzle", 1710140): (1, ''),
    ("two_cozy_puzzle", 4776790): (2, ''),
    ("two_cozy_puzzle", 2479960): (2, ''),
    ("two_cozy_puzzle", 2184770): (2, ''),
    ("two_cozy_puzzle", 1606300): (1, ''),
    ("two_cozy_puzzle", 1635590): (0, ''),
    ("two_cozy_puzzle", 1860500): (1, ''),
    ("two_cozy_puzzle", 2606190): (1, ''),
    ("two_cozy_puzzle", 2825390): (0, ''),
    ("two_cozy_puzzle", 416770): (2, ''),
}


# 합의 태그 사전식 정렬(partition_by_tags) 적용 후 43프로필 상위 30칸에서 새로 올라온 자리.
BLIND_LEX30 = {
    ("two_rhythm_arcade", 774171): (3, ''),
    ("two_rhythm_arcade", 1132840): (3, ''),
    ("two_rhythm_arcade", 248820): (1, ''),
    ("two_rhythm_arcade", 744060): (3, ''),
    ("two_rhythm_arcade", 926870): (3, ''),
    ("two_rhythm_arcade", 1083310): (0, ''),
    ("two_rhythm_arcade", 322170): (3, ''),
    ("two_rhythm_arcade", 1945220): (2, ''),
    ("two_rhythm_arcade", 356400): (3, ''),
    ("two_rhythm_arcade", 580300): (0, ''),
    ("two_rhythm_arcade", 3243370): (3, ''),
    ("two_rhythm_arcade", 1545450): (2, ''),
    ("two_cozy_puzzle", 1597720): (2, ''),
    ("two_cozy_puzzle", 1740300): (3, ''),
    ("two_cozy_puzzle", 3047220): (3, ''),
    ("two_cozy_puzzle", 3463470): (1, ''),
    ("two_cozy_puzzle", 1586800): (3, ''),
    ("two_cozy_puzzle", 1837650): (2, ''),
    ("two_cozy_puzzle", 2781210): (2, ''),
    ("two_cozy_puzzle", 2695080): (1, ''),
    ("two_cozy_puzzle", 3040820): (1, ''),
    ("two_cozy_puzzle", 2723460): (2, ''),
    ("two_cozy_puzzle", 2483440): (2, ''),
    ("two_cozy_puzzle", 2707110): (3, ''),
    ("two_bigaction", 2178070): (2, ''),
    ("two_bigaction", 1206600): (1, ''),
    ("two_bigaction", 204030): (2, ''),
    ("two_bigaction", 1245620): (3, ''),
    ("two_bigaction", 4570720): (2, ''),
    ("two_bigaction", 356190): (3, ''),
    ("two_bigaction", 338140): (1, ''),
    ("coh_mmo", 1088090): (2, ''),
    ("coh_sports", 4654280): (0, ''),
    ("coh_sports", 2878960): (3, ''),
    ("coh_sports", 760640): (2, ''),
    ("coh_sports", 2776660): (2, ''),
    ("coh_sports", 1449500): (1, ''),
    ("coh_sports", 2581370): (2, ''),
    ("coh_sports", 2440510): (2, ''),
    ("coh_sports", 3251300): (2, ''),
    ("coh_sports", 3405990): (1, ''),
    ("coh_jrpg", 1042550): (3, ''),
    ("coh_jrpg", 461510): (1, ''),
    ("coh_jrpg", 409890): (2, ''),
    ("coh_jrpg", 552700): (3, ''),
    ...
    ("six_action_adv", 2239550): (3, ''),
    ("six_action_adv", 3280350): (3, ''),
    ("six_action_adv", 8190): (2, ''),
    ("six_action_adv", 1196090): (2, ''),
    ("six_action_adv", 1850570): (3, ''),
    ("six_action_adv", 447040): (3, ''),
    ("six_action_adv", 406970): (1, ''),
    ("six_action_adv", 2556990): (3, ''),
    ("six_action_adv", 2949910): (0, ''),
    ("twenty_broad", 625340): (1, ''),
    ("twenty_broad", 2119830): (2, ''),
    ("twenty_broad", 55230): (2, ''),
    ("twenty_broad", 1201540): (3, ''),
    ("twenty_broad", 2682580): (1, ''),
    ("twenty_broad", 550): (3, ''),
    ("twenty_broad", 265550): (2, ''),
    ("twenty_broad", 892970): (3, ''),
    ("twenty_broad", 729040): (3, ''),
    ("twenty_broad", 1156060): (2, ''),
    ("twenty_broad", 393420): (2, ''),
    ("coh_fps", 33930): (2, ''),
    ("coh_fps", 209080): (1, ''),
    ("coh_fps", 80): (3, ''),
    ("coh_survival_craft", 1713350): (2, ''),
    ("coh_survival_craft", 1307550): (2, ''),
    ("coh_survival_craft", 2285150): (2, ''),
    ("coh_survival_craft", 1660080): (2, ''),
    ("coh_strategy", 268400): (2, ''),
    ("coh_grand_strategy", 3161270): (1, ''),
    ("coh_grand_strategy", 559310): (1, ''),
    ("coh_grand_strategy", 268400): (2, ''),
    ("coh_grand_strategy", 885970): (3, ''),
    ("coh_vehicle_sim", 313160): (2, ''),
    ("coh_vehicle_sim", 655500): (2, ''),
    ("coh_classic_multi", 10090): (2, ''),
    ("niche_tactics", 1074740): (2, ''),
    ("niche_tactics", 2056210): (3, ''),
    ("niche_tactics", 2842800): (2, ''),
    ("niche_tactics", 1142080): (3, ''),
    ("niche_tactics", 2638050): (2, ''),
    ("niche_cozy_casual", 1322170): (2, ''),
    ("niche_cozy_casual", 461840): (3, ''),
    ("niche_cozy_casual", 788320): (1, ''),
    ("niche_cozy_casual", 1269190): (1, ''),
    ("niche_cozy_casual", 684170): (1, ''),
    ("niche_cozy_casual", 1297230): (1, ''),
    ("niche_cozy_casual", 1224450): (1, ''),
    ("niche_cozy_casual", 699010): (1, ''),
    ("niche_cozy_casual", 731940): (1, ''),
    ("niche_cozy_casual", 1218260): (2, ''),
    ("niche_cozy_casual", 418040): (3, ''),
    ("niche_cozy_casual", 1182470): (2, ''),
    ("niche_sim", 1731930): (1, ''),
    ("niche_sim", 1879220): (2, ''),
    ("niche_sim", 1299430): (2, ''),
    ("niche_sim", 2844700): (2, ''),
    ...
    ("niche_sim", 1591130): (2, ''),
    ("niche_sim", 504210): (3, ''),
    ("niche_roguelite", 1499220): (2, ''),
    ("niche_roguelite", 1318480): (1, ''),
    ("niche_roguelite", 2877790): (1, ''),
    ("niche_roguelite", 1491460): (1, ''),
    ("niche_roguelite", 718190): (2, ''),
    ("niche_roguelite", 1763250): (3, ''),
    ("niche_roguelite", 1930350): (1, ''),
    ("niche_roguelite", 3069050): (1, ''),
    ("lowrev_metroidvania", 1694970): (2, ''),
    ("lowrev_metroidvania", 2832450): (2, ''),
    ("lowrev_metroidvania", 2201910): (2, ''),
    ("lowrev_metroidvania", 1083310): (2, ''),
    ("lowrev_metroidvania", 771700): (2, ''),
    ("lowrev_deckbuilder", 2650340): (2, ''),
    ("lowrev_deckbuilder", 1102190): (3, ''),
    ("lowrev_deckbuilder", 3225730): (2, ''),
    ("lowrev_deckbuilder", 2449390): (2, ''),
    ("lowrev_deckbuilder", 2821380): (2, ''),
    ("lowrev_deckbuilder", 2605600): (2, ''),
    ("lowrev_deckbuilder", 2446010): (2, ''),
    ("lowrev_deckbuilder", 2056210): (3, ''),
    ("lowrev_deckbuilder", 2691350): (2, ''),
    ("lowrev_deckbuilder", 1046300): (3, ''),
    ("lowrev_towerdefense", 366210): (2, ''),
    ("lowrev_towerdefense", 1231460): (2, ''),
    ("lowrev_towerdefense", 241410): (2, ''),
    ("lowrev_towerdefense", 2491700): (3, ''),
    ("lowrev_towerdefense", 3594450): (1, ''),
    ("lowrev_towerdefense", 686570): (1, ''),
    ("lowrev_towerdefense", 201790): (3, ''),
    ("lowrev_towerdefense", 3235170): (2, ''),
    ("lowrev_towerdefense", 3639490): (2, ''),
    ("lowrev_towerdefense", 3418970): (1, ''),
    ("lowrev_towerdefense", 2390260): (2, ''),
    ("lowrev_detective", 3098200): (1, ''),
    ("lowrev_detective", 3573410): (2, ''),
    ("lowrev_detective", 1586820): (2, ''),
    ("lowrev_detective", 2575800): (2, ''),
    ("lowrev_cozy_narrative", 1811290): (0, ''),
    ("lowrev_cozy_narrative", 3273760): (1, ''),
    ("lowrev_cozy_narrative", 3308870): (2, ''),
    ("lowrev_cozy_narrative", 2458980): (2, ''),
    ("lowrev_cozy_narrative", 1225200): (2, ''),
    ("lowrev_cozy_narrative", 3282480): (1, ''),
    ("lowrev_cozy_narrative", 1799820): (1, ''),
    ("lowrev_cozy_narrative", 2234600): (2, ''),
    ("lowrev_cozy_narrative", 3542690): (2, ''),
    ("lowrev_cozy_narrative", 3976490): (0, ''),
    ("lowrev_cozy_narrative", 2175900): (2, ''),
    ("lowrev_cozy_narrative", 1451120): (2, ''),
    ("lowrev_cozy_narrative", 2685610): (0, ''),
    ("lowrev_cozy_narrative", 1122700): (3, ''),
    ("lowrev_cozy_narrative", 1500980): (2, ''),
    ("lowrev_cozy_narrative", 3394250): (1, ''),
    ("lowrev_cozy_narrative", 2712540): (0, ''),
    ("mix2_coop_horror", 2695940): (3, ''),
    ("mix2_arcade_action", 991560): (2, ''),
    ("mix2_arcade_action", 1240590): (1, ''),
    ("mix2_builder_sim", 1066780): (3, ''),
    ("mix2_survival_farm", 1589120): (3, ''),
    ("mix2_survival_farm", 1677110): (3, ''),
    ("mix2_survival_farm", 2800450): (1, ''),
    ("mix2_survival_farm", 2811830): (1, ''),
    ("mix2_survival_farm", 3310510): (0, ''),
    ("mix2_survival_farm", 418030): (2, ''),
    ("mix2_survival_farm", 253250): (2, ''),
    ("mix2_survival_farm", 1662710): (1, ''),
    ("mix2_survival_farm", 2997840): (1, ''),
    ("mix2_survival_farm", 1805110): (2, ''),
    ("mix2_survival_farm", 1149460): (2, ''),
    ("mix2_survival_farm", 233860): (2, ''),
    ("mix2_survival_farm", 1323900): (2, ''),
    ("mix2_survival_farm", 1623730): (3, ''),
    ("mix2_party_narrative", 690640): (3, ''),
    ("mix2_party_narrative", 1938750): (2, ''),
    ("mix2_party_narrative", 1092630): (1, ''),
    ("mix2_party_narrative", 249990): (1, ''),
    ("mix2_party_narrative", 204360): (2, ''),
    ("mix2_party_narrative", 1488430): (2, ''),
    ("mix2_party_narrative", 1599660): (3, ''),
    ("mix2_party_narrative", 760810): (1, ''),
    ("mix2_party_narrative", 238460): (3, ''),
    ("mix2_party_narrative", 1080010): (2, ''),
    ("mix2_party_narrative", 2477090): (1, ''),
    ("mix2_party_narrative", 323850): (2, ''),
    ("mix2_party_narrative", 2215260): (2, ''),
    ("mix2_party_narrative", 4583130): (2, ''),
    ("longtail_metroidvania", 2687280): (2, ''),
    ("longtail_metroidvania", 4565080): (2, ''),
    ("longtail_metroidvania", 1795780): (1, ''),
    ("longtail_metroidvania", 2534370): (3, ''),
    ("longtail_metroidvania", 1094540): (2, ''),
    ("longtail_metroidvania", 2182390): (2, ''),
    ("longtail_metroidvania", 1698220): (3, ''),
    ("longtail_metroidvania", 2582300): (2, ''),
    ("longtail_metroidvania", 1132910): (2, ''),
    ("longtail_metroidvania", 1356360): (1, ''),
    ("longtail_metroidvania", 1332950): (2, ''),
    ("longtail_metroidvania", 4128370): (1, ''),
    ("longtail_metroidvania", 1798350): (1, ''),
    ("longtail_metroidvania", 1000760): (3, ''),
    ("longtail_deckbuilder", 2056210): (3, ''),
    ("longtail_deckbuilder", 2473410): (2, ''),
    ("longtail_deckbuilder", 1102190): (3, ''),
    ("longtail_deckbuilder", 1419510): (1, ''),
    ("longtail_deckbuilder", 2358770): (2, ''),
    ("longtail_deckbuilder", 2446010): (2, ''),
    ("longtail_deckbuilder", 3152660): (2, ''),
    ("longtail_deckbuilder", 4157010): (2, ''),
    ("longtail_deckbuilder", 2648980): (1, ''),
    ("longtail_deckbuilder", 3097450): (1, ''),
    ("longtail_deckbuilder", 3929330): (2, ''),
    ("longtail_deckbuilder", 1608040): (3, ''),
    ("longtail_puzzle_platformer", 314660): (3, ''),
    ("longtail_puzzle_platformer", 308060): (3, ''),
    ("longtail_puzzle_platformer", 485030): (3, ''),
    ("longtail_puzzle_platformer", 329380): (2, ''),
}
