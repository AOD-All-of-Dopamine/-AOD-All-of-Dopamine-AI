...
COHERENT_PROFILES = [
    {
        "profile_id": "coh_fps",
        "liked_ids": [730, 578080, 359550],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_survival_craft",
        "liked_ids": [108600, 219740, 242760],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_openworld_survival",
        "liked_ids": [264710, 305620, 275850],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_strategy",
        "liked_ids": [289070, 268500, 281990],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_grand_strategy",
        "liked_ids": [394360, 236850, 8930],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_arpg",
        "liked_ids": [374320, 292030, 489830],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_indie_platformer",
        "liked_ids": [367520, 588650, 504230],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_cozy",
        "liked_ids": [413150, 433340, 648800],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_vehicle_sim",
        "liked_ids": [227300, 284160, 244210],
        "profile_type": "coherent",
    },
    {
        "profile_id": "coh_classic_multi",
        "liked_ids": [4000, 440, 550],
        "profile_type": "coherent",
    },
]
...
MIXED_PROFILES = [
    {
        ...
        "liked_ids": [730, 578080, 413150],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_survival_strategy",
        "liked_ids": [242760, 251570, 289070],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_rpg_racing",
        "liked_ids": [292030, 489830, 284160],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_indie_multi",
        "liked_ids": [367520, 588650, 4000],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_openworld_cozy",
        "liked_ids": [275850, 264710, 433340],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_vehicle_fps",
        "liked_ids": [227300, 244210, 550],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_arpg_survival",
        "liked_ids": [374320, 377160, 242760],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_grand_casual",
        "liked_ids": [8930, 236850, 477160],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_multi_indie",
        "liked_ids": [440, 550, 105600],
        "profile_type": "mixed",
    },
    {
        "profile_id": "mix_cozy_fps",
        "liked_ids": [648800, 413150, 730],
        "profile_type": "mixed",
    },
]
...
def validate_split(dev_df: pd.DataFrame, val_df: pd.DataFrame) -> None:
    ...
    dev_seed_sets = [set(p) for p in dev_df["liked_ids"]]
    val_seed_sets = [set(p) for p in val_df["liked_ids"]]
    ...
    dev_seeds_all = set()
    for p in dev_df["liked_ids"]:
        dev_seeds_all.update(p)
    val_seeds_all = set()
    for p in val_df["liked_ids"]:
...
if __name__ == "__main__":
    ...
    for _, r in df.iterrows():
        print(f"  {r['profile_id']:20s} [{r['split']}] liked={r['liked_ids']}")
